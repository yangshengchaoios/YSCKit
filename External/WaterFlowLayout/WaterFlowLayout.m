...
- (void)prepareLayout
{
    ...
    //    NSAssert([self.delegate conformsToProtocol:@protocol(WaterFlowLayoutDelegate)], @"UICollectionView's delegate should conform to WaterFlowLayoutDelegate protocol");
